...
base_model = InceptionV3(weights='D:\Laptrinh\BTL\BTL_TGMT2\image-caption-generator/inception_v3_weights_tf_dim_ordering_tf_kernels.h5')
...
pickle_in = open("image-caption-generator/wordtoix.pkl", "rb")

wordtoix = load(pickle_in)
pickle_in = open("image-caption-generator/ixtoword.pkl", "rb")
...
model = load_model('image-caption-generator/image-caption-30k-39.h5')
